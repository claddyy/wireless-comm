...
A1=[-2 6];
B1=[6,3];
C1 = dot(A1,B1); disp('Dot Product is ='); 
disp(C1);
...
Mt= M';
disp('Tranpose of Matrix M is ='); disp(Mt);
%8. Converting Matrix to column vector
Mc= M(:);
disp('Column Vector of Matrix M is ='); disp(Mc);
%9. Multiplication of matrices
v=[3; 4];
X=M*v;
disp('Multiplication of matrices M and V is ='); disp(X);
